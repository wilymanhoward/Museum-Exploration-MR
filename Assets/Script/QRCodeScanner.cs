...
public class QRCodeScanner : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Handle Editor keyboard simulations
        if (enableEditorSimulation && Application.isEditor)
        {
            HandleEditorInputs();
        }
    ...
    {
        // Simulate scanning Room transition QR codes (Room 1, 2, 3)
        if (Input.GetKeyDown(KeyCode.Alpha1)) SimulateScan("room_1");
        else if (Input.GetKeyDown(KeyCode.Alpha2)) SimulateScan("room_2");
        else if (Input.GetKeyDown(KeyCode.Alpha3)) SimulateScan("room_3");

        // Simulate scanning Artifact QR codes (Artifact 1, 2, 3)
        else if (Input.GetKeyDown(KeyCode.Q)) SimulateScan("artifact_1");
        else if (Input.GetKeyDown(KeyCode.W)) SimulateScan("artifact_2");
        else if (Input.GetKeyDown(KeyCode.E)) SimulateScan("artifact_3");
